"""
   ...
   This program generates emails to be sent out after Hesburgh Lecture events.
...
def search_lectures_and_draft_email():
    # Searches events table in Access for lectures that have been completed
    print('Drafting Post-Lecture Emails...\n')
    ...
    for row in lectures:
        try:
            ...
            if lect_date < today and row['co-sponsor contact 2 e-mail'] is None and row['status'] is None:
...
def draft_email(clubname, header_date, body_date, coor_name, cemail, fprefix, ffirst, flast, femail):
    ...
    subject = '2018 Follow-up on Hesburgh Lecture for ND Club of ' + clubname + ', ' + header_date
    with open(r'G:\Team Drives\Alumni All Staff\Hesburgh Lecture Series\_HLS Code - DO NOT DELETE OR MOVE\Post-Lecture_Email_Content.txt', encoding='utf8') as f:
